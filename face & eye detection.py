...
face_classifier = cv2.CascadeClassifier(r"C:\Users\akhil gunti\AGENTIC_AI\haarcascade\haarcascade_frontalface_default.xml")
# Load the image
image = cv2.imread(r"C:\Users\akhil gunti\Downloads\IMG_0698.jpg")
